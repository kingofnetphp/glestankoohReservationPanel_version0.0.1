...
class LoadingBackdropService {
    ...
    show() {
        ...
        bodyElement === null || bodyElement === void 0 ? void 0 : bodyElement.appendChild(backdropWrapperElement);
    }
    hide() {
        const backdropWrapperElement = document.querySelector('#loadingBackdrop');
        backdropWrapperElement === null || backdropWrapperElement === void 0 ? void 0 : backdropWrapperElement.remove();
    }
        ...
        if (this.CheckRequiredMobile()) {
            ...
            this.libRegisterPanelService
                ...
                if (data.success) {
                    ...
                    this.snackBar.open(this.textconstants.REGISTERMOBILEUNVALID, 'باشه', { duration: 10000 });
                    valicodeField === null || valicodeField === void 0 ? void 0 : valicodeField.classList.add('mat-form-field-danger');
                }
            }, error => { });
        }
    }
